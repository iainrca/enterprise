...
jQuery(document).ready(function() {
  ...
  jQuery('tr.detailItemsTableRow td.detailItemsTable_CALLNUMBER').each(function () {              
       ...
       if(validSMLocs.indexOf(Loc) !== -1) {      
          ...
          jQuery(this).append( "<div id='shelfmap'><a href='https://app.shelfmap.co.uk/fp/fp?icode=44RCA&id=" + bibid + "' target='_blank' class='ShelfMap_anchor' title='Show item on ShelfMap'><img src='https://iainrca.github.io/summon/v2.svg' alt='ShelMap drop pin' height = '75px' width='75px' style="float:right"/>View Shelf Location</a></div></br>" );         
        }  
     });
