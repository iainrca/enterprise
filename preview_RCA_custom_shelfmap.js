...
jQuery(document).ready(function() {
  ...
  jQuery('tr.detailItemsTableRow td.detailItemsTable_CALLNUMBER').each(function () {              
       ...
       if(validSMLocs.indexOf(Loc) !== -1) {      
          ...
          jQuery(this).append( "<br/><span id='shelfmap'><a href='https://app.shelfmap.co.uk/fp/fp?icode=44RCA&id=" + bibid + "' target='_blank' class='ShelfMap_anchor' title='Show item on ShelfMap'>View Shelf Location</a></span></br>" );         
